...
Route::namespace('Submissao')->group(function () {
    Route::get('/evento/visualizar/{id}', [EventoController::class, 'show'])->name('evento.visualizar');
...
Route::group(['middleware' => ['auth', 'verified', 'isTemp']], function () {
    ...
    Route::namespace('Submissao')->group(function () {
        ...
        Route::get('atividades/{id}/inscrever', [AtividadeController::class, 'inscrever'])->name('atividades.inscricao');
        Route::get('atividades/{id}/{user}/cancelarInscricao', [AtividadeController::class, 'cancelarInscricao'])->name('atividades.cancelarInscricao');
        ...
        //Evento
        Route::get('/evento/criar', [EventoController::class, 'create'])->name('evento.criar');
        Route::post('/evento/criar', [EventoController::class, 'store'])->name('evento.criar');
    ...
    Route::get('{id}/inscricoes/excluir-categoria', [CategoriaController::class, 'destroy'])->name('categoria.destroy');
    Route::post('{id}/inscricoes/atualizar-categoria', [CategoriaController::class, 'update'])->name('categoria.participante.update');
